...
public class Ngay {
	...
	public static Date timestampToDate(Timestamp ts) {
		return new Date(ts.getYear(), ts.getMonth(), ts.getDate()-1);
	}
	
	public static LocalDateTime dateToLocalDateTime(Date d) {
		return LocalDateTime.of(d.getYear() + 1900, d.getMonth()+1, d.getDate(), 0, 0);
	}
...
//		ts.getTime
	...
	public static void main(String[] args) {
		...
		System.out.println(Ngay.dateToLocalDateTime(Ngay.homNay()));
	}
}
